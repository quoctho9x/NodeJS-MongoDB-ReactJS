...
A simple Nodejs, Mongodb, Reactjs, Webpack 3, and React Router v4.

#### https://github.com/quoctho9x/NodeJS-MongoDB-ReactJS
...
#### State Management
* [redux-saga](https://github.com/redux-saga/redux-saga) for redux
...
#### HTTP
* Fetch Read more here [Fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)
